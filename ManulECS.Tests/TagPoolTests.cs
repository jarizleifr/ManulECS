...
namespace ManulECS.Tests {
  public class DenseTagPoolTests : TagPoolFacts<DenseTagPool<Tag>> {
    protected override TagPool<Tag> GetPool() => new DenseTagPool<Tag>() { Flag = new Flag(0, 1u) };
  }

  public class SparseTagPoolTests : TagPoolFacts<SparseTagPool<Tag>> {
    protected override TagPool<Tag> GetPool() => new SparseTagPool<Tag>() { Flag = new Flag(0, 1u) };
  }
